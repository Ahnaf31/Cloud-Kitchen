...
<section class="main">
	...
	<h1 id="abc"><span style=color:#5c5c8a><b>Search your expected Delivery Man from this table :</b></span></h1>
	...
	<script type="text/javascript">
		...
		function selected_list(){
			...
			xhttp.open("GET", "../controller/DeliveryMan_details_controller.php?key="+search, true);
			xhttp.send(); 
		}
	</script>		
