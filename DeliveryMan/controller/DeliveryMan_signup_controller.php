  ...
  if(!empty($_POST["password"]) && ($_POST["password"] == $_POST["Cpassword"])) 
	...
	if($flag==1)
		...
		if(!$con)
		{
			...
			header("refresh:6;	url=../view/DeliveryMan_signup.php");
		}		
		else
		{
		
		$sql = "INSERT INTO `delivery` (`fname`,`username`,`password`,`email`,`nid`,`gender`) VALUES ('$fname','$username','$password','$email','$nid','$gender')";
				
			if(mysqli_query($con, $sql))
			{
				echo ' "COngraTS !! New Delivery man Data is inserTed successfully! Now You can Login <a href="/project/CloudKitchen/DeliveryMan/view/DeliveryMan_Login.php">Login</a> |
  <hr>
';
				header("url=../view/DeliveryManDashboard.php");
			}
			else
			{
				echo "!! ERROR to store in database !!";
				header('Location: /project/CloudKitchen/DeliveryMan/view/DeliveryMan_signup.php');
			}
