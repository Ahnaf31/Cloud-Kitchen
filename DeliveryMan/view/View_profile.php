                ...
                <div  align=center class="table-responsive"> 
                     <table class="table table-bordered">  
						  ...
						  <?php
							$pp_path = '';
							if (isset($_SESSION['username'])) {
                          $data = file_get_contents("C:/xampp/htdocs/project/CloudKitchen/DeliveryMan/json/Data_deliveryman.json");  
                          $array = json_decode($data); 
                          foreach($array as $row)  
                          {  
							
								
								echo '<img src="' . $row->pp . '"width="150" height="150"> <br><a href="/project/CloudKitchen/DeliveryMan/view/Profile_pic.php">Change Profile Picture</a> <br>';
							...
							echo '<b><a href="Update_profile.php"> Edit Profile</a></b> <br>';
										...
										header('Location: /project/CloudKitchen/DeliveryMan/view/Admin_Login.php');
									}
                          ?>  
